...
However, it seems this definition is nonintuitively recursive, I believe the intent of \autoref{eq:aca:fraction} is that shown in \autoref{eq:aca:fraction-max}.
