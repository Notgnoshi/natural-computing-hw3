...
\todoinline{
    \begin{itemize}
        \item Show the implementation of one iteration.
        \item Show the output of \mintinline{text}{./prob2.py --help} and mention all of the tweakable parameters we wanted to be able to play with.
    \end{itemize}
}
