...
\autoref{fig:pso:100-particles} and \autoref{fig:pso:5-particles} shows the results with 100 and 5 particles respectively.
...
\paragraph*{The Acceleration Constants $AC_1$ and $AC_2$}
\paragraph*{The Velocity Bounds $[v_{\min}, v_{\max}]$}
