...
\subsubsection{Number of Ants} The most obvious parameter to tweak is the number of ants.
...
\subsubsection{Ant Perceptive Distance} As mentioned, we implemented the ability to increase each ant's perceptive range by increasing the radius of the neighborhood around them when calculating the perceived fraction $f$ from \autoref{eq:aca:density}.
